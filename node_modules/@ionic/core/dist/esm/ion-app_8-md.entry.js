import { r as registerInstance, c as getIonMode, h, H as Host, e as getElement, d as createEvent, f as readTask, w as writeTask } from './core-0a8d4d2e.js';
...
import { t as transition } from './index-1469ea79.js';
    ...
    componentDidLoad() {
        {
            rIC(() => {
                ...
                if (!config.getBoolean('_testing')) {
                    import('./tap-click-606f325e.js').then(module => module.startTapClick(config));
                }
                if (config.getBoolean('statusTap', isHybrid)) {
                    import('./status-tap-2ec46489.js').then(module => module.startStatusTap());
                }
                if (config.getBoolean('inputShims', needInputShims())) {
                    import('./input-shims-a4fc53ac.js').then(module => module.startInputShims(config));
                }
                if (config.getBoolean('hardwareBackButton', isHybrid)) {
                    import('./hardware-back-button-1ed0083a.js').then(module => module.startHardwareBackButton());
                }
                import('./focus-visible-70713a0c.js').then(module => module.startFocusVisible());
            });
        }
    }
    render() {
...
const RouterOutlet = class {
    ...
    async connectedCallback() {
        this.gesture = (await import('./swipe-back-d2cdbf9a.js')).createSwipeBackGesture(this.el, () => !!this.swipeHandler && this.swipeHandler.canStart() && this.animationEnabled, () => this.swipeHandler && this.swipeHandler.onStart(), step => this.ani && this.ani.progressStep(step), (shouldComplete, step, dur) => {
            if (this.ani) {
