...
const index$1 = require('./index-bbd98f6f.js');
...
const App = class {
    ...
    componentDidLoad() {
        {
            rIC(() => {
                const isHybrid = config.isPlatform(window, 'hybrid');
                if (!config.config.getBoolean('_testing')) {
                    new Promise(function (resolve) { resolve(require('./tap-click-8317f2ba.js')); }).then(module => module.startTapClick(config.config));
                }
                if (config.config.getBoolean('statusTap', isHybrid)) {
                    new Promise(function (resolve) { resolve(require('./status-tap-92af075e.js')); }).then(module => module.startStatusTap());
                }
                if (config.config.getBoolean('inputShims', needInputShims())) {
                    new Promise(function (resolve) { resolve(require('./input-shims-da85559e.js')); }).then(module => module.startInputShims(config.config));
                }
                if (config.config.getBoolean('hardwareBackButton', isHybrid)) {
                    new Promise(function (resolve) { resolve(require('./hardware-back-button-1be0db15.js')); }).then(module => module.startHardwareBackButton());
                }
                new Promise(function (resolve) { resolve(require('./focus-visible-799542c9.js')); }).then(module => module.startFocusVisible());
            });
        }
    }
    render() {
...
const needInputShims = () => {
    return config.isPlatform(window, 'ios') && config.isPlatform(window, 'mobile');
};
const rIC = (callback) => {
...
const Content = class {
    ...
    shouldForceOverscroll() {
        ...
        return forceOverscroll === undefined
            ? mode === 'ios' && config.isPlatform('ios')
            : forceOverscroll;
    }
    resize() {
        if (this.fullscreen) {
    ...
    render() {
        ...
        const transitionShadow = (mode === 'ios' && config.config.getBoolean('experimentalTransitionShadow', true));
        this.resize();
        return (core.h(core.Host, { class: Object.assign(Object.assign({}, theme.createColorClasses(this.color)), { [mode]: true, 'content-sizing': theme.hostContext('ion-popover', this.el), 'overscroll': forceOverscroll }), style: {
            ...
            } }, core.h("div", { id: "background-content" }), core.h("main", { class: {
                'inner-scroll': true,
                'scroll-x': scrollX,
                'scroll-y': scrollY,
                'overscroll': (scrollX || scrollY) && forceOverscroll
            }, ref: el => this.scrollEl = el, onScroll: (this.scrollEvents) ? ev => this.onScroll(ev) : undefined }, core.h("slot", null)), transitionShadow ? (core.h("div", { class: "transition-effect" }, core.h("div", { class: "transition-cover" }), core.h("div", { class: "transition-shadow" }))) : null, core.h("slot", { name: "fixed" })));
    }
    get el() { return core.getElement(this); }
...
const RouterOutlet = class {
    ...
    async connectedCallback() {
        this.gesture = (await new Promise(function (resolve) { resolve(require('./swipe-back-b4dc158d.js')); })).createSwipeBackGesture(this.el, () => !!this.swipeHandler && this.swipeHandler.canStart() && this.animationEnabled, () => this.swipeHandler && this.swipeHandler.onStart(), step => this.ani && this.ani.progressStep(step), (shouldComplete, step, dur) => {
            if (this.ani) {
    ...
    async transition(enteringEl, leavingEl, opts = {}) {
        ...
        const animationBuilder = this.animation || opts.animationBuilder || config.config.get('navAnimation');
