...
const Nav = class {
    ...
    async componentDidLoad() {
        this.rootChanged();
        this.gesture = (await new Promise(function (resolve) { resolve(require('./swipe-back-b4dc158d.js')); })).createSwipeBackGesture(this.el, this.canStart.bind(this), this.onStart.bind(this), this.onMove.bind(this), this.onEnd.bind(this));
        this.swipeGestureChanged();
    }
    componentDidUnload() {
        for (const view of this.views) {
            index$1.lifecycle(view.element, constants.LIFECYCLE_WILL_UNLOAD);
            view._destroy();
        }
        if (this.gesture) {
    ...
    postViewInit(enteringView, leavingView, ti) {
        ...
        if (destroyQueue && destroyQueue.length > 0) {
            for (const view of destroyQueue) {
                index$1.lifecycle(view.element, constants.LIFECYCLE_WILL_LEAVE);
                index$1.lifecycle(view.element, constants.LIFECYCLE_DID_LEAVE);
                index$1.lifecycle(view.element, constants.LIFECYCLE_WILL_UNLOAD);
            }
    ...
    cleanup(activeView) {
        ...
        for (let i = views.length - 1; i >= 0; i--) {
            ...
            if (i > activeViewIndex) {
                ...
                // let's unload it
                index$1.lifecycle(element, constants.LIFECYCLE_WILL_UNLOAD);
                this.destroyView(view);
            }
