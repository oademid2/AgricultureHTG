import { r as registerInstance, d as createEvent, c as getIonMode, h, e as getElement, H as Host } from './core-0a8d4d2e.js';
...
import { l as lifecycle, t as transition, s as setPageHidden } from './index-1469ea79.js';
...
const Nav = class {
    ...
    async componentDidLoad() {
        this.rootChanged();
        this.gesture = (await import('./swipe-back-d2cdbf9a.js')).createSwipeBackGesture(this.el, this.canStart.bind(this), this.onStart.bind(this), this.onMove.bind(this), this.onEnd.bind(this));
